...
if(!empty($_POST)) // Om något är submittat.
{
	if(strlen($_POST["message"]) < 3)
	{
		die("Ditt meddelande är för kort. Du måste ha minst 3 tecken.");
	}

	if(empty($_POST["name"]))
	{
		die("Du måste skriva ett namn");
	}
}
else
{
